...
# Load the references
#bahman.ref.aggr <- read.csv("/Users/cauleyes/CCBR/CCBR-1245_Ramaswami/spatial_decon/bahman_ref_aggr.csv")

bahman.ref.avg <- read.csv("/Users/cauleyes/CCBR/CCBR-1245_Ramaswami/spatial_decon/bahman_ref_avg.csv")

rownames(bahman.ref.avg) <- bahman.ref.avg$X

bahman.ref.avg <- bahman.ref.avg %>% select(-X)

bahman.ref.matrix <- as.matrix(bahman.ref.avg)

#inf_values <- is.infinite(bahman.ref.matrix)

# Find the rows and columns with Inf values
#inf_locations <- which(inf_values, arr.ind = TRUE)
#print(inf_locations)

# Replace INF values
#bahman.ref.matrix[is.infinite(bahman.ref.matrix)] <- NA


spatial.decon.bahman = runspatialdecon(object = object,
                      norm_elt = "q_norm",
                      raw_elt = "exprs",
                      X = bahman.ref.matrix,
                      align_genes = TRUE, 
