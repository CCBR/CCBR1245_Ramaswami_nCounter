...
results.folder <- "/Users/cauleyes/CCBR/CCBR-1245_Ramaswami/Results/November2024/"
run.folder <- "DSP/11_15_24/"
...
volcano.output <- make_volcano(lmm.results = results.df, 
                               title = contrast.name, 
                               legend.title = "DSP Samples, Tumor AOIs", 
                               x.axis.title = "High vs. Low")
...
volcano.output <- make_volcano(lmm.results = results.df, 
                               title = contrast.name, 
                               legend.title = "DSP Samples, LANA+ AOIs", 
                               x.axis.title = "High vs. Low", 
                               fc.limit = 1)

custom.volcano.output <- make_volcano(lmm.results = results.df, 
                               title = "LANA+ AOIs High vs. Low CD4 Count", 
                               legend.title = "High CD4 Count AOI Expression", 
                               x.axis.title = "High vs. Low CD4 Count", 
...
pca.plot.cd4.count <- biplot(pca.table, 
                       ...
                       lab = NULL,
                       title = NULL, 
                       subtitle = "DSP/nCounter Samples LANA AOIs")
...
volcano.output <- make_volcano(lmm.results = results.df, 
                               title = contrast.name, 
                               legend.title = "DSP Samples, full ROI AOIs", 
                               x.axis.title = "High vs. Low")
...
pca.plot.cd4.count <- biplot(pca.table, 
                       ...
                       lab = NULL,
                       title = NULL, 
                       subtitle = "DSP/nCounter Samples full ROI AOIs")
...
volcano.output <- make_volcano(lmm.results = results.df, 
                               title = contrast.name, 
                               legend.title = "DSP Samples, all AOIs", 
                               x.axis.title = "Tumor vs. Vessel")
...
volcano.output <- make_volcano(lmm.results = results.df, 
                               title = contrast.name, 
                               legend.title = "DSP nCounter Samples", 
                               x.axis.title = "LANA + vs. Vessel")

custom.volcano.output <- make_volcano(lmm.results = results.df, 
                               title = "LANA+ AOIs vs. LANA- Vessel and Immune AOIs",
                               fc.limit = 1, 
                               legend.title = "LANA+ AOI Expression", 
                               x.axis.title = "LANA + vs. Vessel and Immune", 
                               custom.gene.labels <- c("STC1", 
                                                       "MKI67", 
                                                       "LYVE1", 
                                                       "TSPAN15", 
...
q3.normalized.reads <- spatial.input$subset.object@assayData$q_norm
feature.data <- fData(spatial.input$subset.object)
...
spatial.decon.skin = runspatialdecon(object = spatial.input$subset.object,
                      norm_elt = "q_norm",
                      raw_elt = "exprs",
                      X = human.skin.ref,
                      align_genes = TRUE, 
...
spatial.decon.immune = runspatialdecon(object = spatial.input$subset.object,
                      norm_elt = "q_norm",
                      raw_elt = "exprs",
                      X = human.immune.ref,
                      align_genes = TRUE, 
...
rownames(skin.cell.scores) <- skin.cell.scores$segmentID
skin.cell.scores <- skin.cell.scores %>% 
  select(-segmentID, -sample_ID)
rownames(immune.cell.scores) <- immune.cell.scores$segmentID
...
skin.cell.perc.transform$segmentID <- rownames(skin.cell.perc.transform)

immune.cell.perc.transform <- as.data.frame(t(immune.cell.perc))
immune.cell.perc.transform$segmentID <- rownames(immune.cell.perc.transform)
...
# Make the bar plots
skin.bar.plot <- ggplot(data = skin.cell.melt, aes(x = segmentID, 
                                                   y = value, 
                                                   fill = cell.type)) + 
...
immune.bar.plot <- ggplot(data = immune.cell.melt, aes(x = segmentID, 
                                                   y = value, 
                                                   fill = cell.type)) + 
  geom_bar(stat = "identity", color = "black") + 
  facet_wrap(~region, scales = "free_x") + 
